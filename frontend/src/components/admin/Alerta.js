...
const Alerta = (props) => {
    ...
    return (
        <div className="fixed  bottom-8 mx-auto" style={{ width: '600px', left: 'calc(50% - 350px)' }}>
            {(tipo === "error") ?
                <div className="rounded-md shadow-sm bg-red-50 w-full p-4 w-10/12 flex flex-row items-center ">
