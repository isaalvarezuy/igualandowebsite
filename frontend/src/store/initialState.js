...
export const initialState = {
    ...
    equipos: [],
    equipo1: "",
    sociaVitalicia: { "fotoFondo": "", "fotoMain": "", "nombre": "", "profesion": "", "fecha": "", "spCode": "", "frase": "" },
    albums: [],
    deportes: [],
    integrantes: [
        { nombre: "Cecilia Piazza", rol: "Periodista deportivo", chiste: "Lengua filosa", foto: "https://res.cloudinary.com/isita/image/upload/v1636928040/static/Avatars_web_2x_pk94de.png" },
